package geekbrains.material.ui.todolist
...
class ToDoListActivity : AppCompatActivity() {
    ...
    private fun createItemList(): List<Pair<Data, Boolean>> {
        return listOf(
            Pair(Data(1, "Дело 1", "Описание 1"), false),
            Pair(Data(2, "Дело 2", "Описание 2"), false),
            Pair(Data(3, "Дело 3", "Описание 3"), false),
            Pair(Data(4, "Дело 4", "Описание 4"), false),
            Pair(Data(5, "Дело 5", "Описание 5"), false),
            Pair(Data(6, "Дело 6", "Описание 6"), false)
        )
    }
}
    ...
    inner class BaseViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView),
        ...
        private fun setSaveAction(dataItem: Pair<Data, Boolean>) {
            itemView.saveButton.setOnClickListener {
                ...
                itemView.todoHeader.text = itemView.todoHeaderEdit.text.toString()

                itemView.todoDescriptionEdit.visibility = View.GONE
                itemView.todoDescription.visibility = View.VISIBLE
                itemView.todoDescription.text = itemView.todoDescriptionEdit.text.toString()
